...
> Recipe management — collect, organize, and share recipes

**Status:** 🔴 Inactive | **Portainer ID:** 188 | **Category:** 📦 Productivity & Collaboration
...
```
${STORAGE_ROOT}/postgres:${PGDATA}
${STORAGE_ROOT}/files:/opt/recipes/files
${STORAGE_ROOT}/media:/opt/recipes/mediafiles
```
