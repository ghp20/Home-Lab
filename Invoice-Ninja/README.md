...
Self-hosted invoicing and billing platform with workers and cache services.

## Included services

- `invoiceninja` — `invoiceninja-octane`
- `invoiceninja-db` — `mariadb`
- `invoiceninja-redis` — `valkey`
- `invoiceninja-scheduler` — `invoiceninja-octane`
- `invoiceninja-worker` — `invoiceninja-octane`
