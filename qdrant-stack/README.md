...
> Vector database — semantic search and RAG for AI applications

**Status:** 🟢 Active | **Portainer ID:** 256 | **Category:** 🤖 AI & Development
...
```
${NVME_STORAGE}:/qdrant/storage
${STORAGE_ROOT}/snapshots:/qdrant/snapshots
${STORAGE_ROOT}/config:/qdrant/config
```
