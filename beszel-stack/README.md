...
> Lightweight server monitoring hub — agent-based multi-server tracking

**Status:** 🟢 Active | **Portainer ID:** 180 | **Category:** 🖥 Infrastructure & Monitoring
...
```
${STORAGE_ROOT}/hub-data:/beszel_data
${STORAGE_ROOT}/socket:/beszel_socket
${STORAGE_ROOT}/agent-data:/var/lib/beszel-agent
${STORAGE_ROOT}/socket:/beszel_socket
