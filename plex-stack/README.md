...
> Plex Media Server — alternative media streaming (currently inactive)

**Status:** 🔴 Inactive | **Portainer ID:** 153 | **Category:** ⚡ Media & Entertainment
...
${STORAGE_ROOT}/transcode:/transcode
${MEDIA_ROOT}:/media
```
