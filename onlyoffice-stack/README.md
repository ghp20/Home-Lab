...
> Office document server — collaborative doc editing for Nextcloud

**Status:** 🟢 Active | **Portainer ID:** 12 | **Category:** 📦 Productivity & Collaboration
...
```
${STORAGE_ROOT}/data:/var/www/onlyoffice/Data
${STORAGE_ROOT}/logs:/var/log/onlyoffice
```
