...
> Recipe manager & meal planner — import from any website, plan meals

**Status:** 🟢 Active | **Portainer ID:** 189 | **Category:** 📦 Productivity & Collaboration
...
${STORAGE_ROOT}/mealie/data:/app/data
```
