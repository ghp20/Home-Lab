...
Variant of the trading agent stack with separate backend and dependencies.

## Included services

- `trading-agent-ron` — `trading-agent-ron`
- `trading-postgres-ron` — `postgres`
- `trading-redis-ron` — `redis`
