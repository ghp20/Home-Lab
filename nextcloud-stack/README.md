...
> Self-hosted cloud — file sync, calendar, contacts, talk, and apps

**Status:** 🟢 Active | **Portainer ID:** 323 | **Category:** 📦 Productivity & Collaboration
...
```
${STORAGE_ROOT}/appdata:/var/www/html
${STORAGE_ROOT}/userdata:/var/www/html/data
...
⚠️ Cron job must run regularly (every 5 min) for background tasks

⚠️ Large file uploads (>1GB) require PHP memory_limit and upload_max_filesize tuning

⚠️ Always backup both the database AND the data directory before upgrades

⚠️ Redis cache significantly improves UI responsiveness — don't skip it
