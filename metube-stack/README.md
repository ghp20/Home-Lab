...
> YouTube video downloader with web UI — grab videos locally

**Status:** 🟢 Active | **Portainer ID:** 181 | **Category:** ⚡ Media & Entertainment
...
```
${MEDIA_ROOT}:/downloads:rw
${STORAGE_ROOT}/state:/downloads/.metube:rw
```
