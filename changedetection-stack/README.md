...
> Website change monitor — get alerted when pages update

**Status:** 🟢 Active | **Portainer ID:** 300 | **Category:** 🔒 Networking & VPN
...
```
/path/to/data/apps_config/changedetection/datastore:/datastore
```
