...
> Jellyfin analytics dashboard — track media consumption stats

**Status:** 🟢 Active | **Portainer ID:** 219 | **Category:** ⚡ Media & Entertainment
...
${STORAGE_ROOT}/backup:/app/backend/backup-data
```
